...
func runGUI() {
	...
	if err := (dcl.MainWindow{
		...
		Background: dcl.SolidColorBrush{Color: walk.RGB(15, 20, 28)},
		Children: []dcl.Widget{
			...
			dcl.Label{Text: "ProxyLink Support", Font: dcl.Font{Family: "Segoe UI", PointSize: 16, Bold: true}, TextColor: walk.RGB(240, 169, 59)},
			dcl.Label{Text: "Secure one-time remote support", TextColor: walk.RGB(138, 151, 168)},
			dcl.VSpacer{Size: 8},
			dcl.Label{Text: "Enter the code your technician gave you:", TextColor: walk.RGB(238, 242, 247)},
			dcl.LineEdit{AssignTo: &codeEdit, MaxLength: 8, Text: preCode, Font: dcl.Font{Family: "Consolas", PointSize: 13},
				Background: dcl.SolidColorBrush{Color: walk.RGB(7, 10, 15)}, TextColor: walk.RGB(238, 242, 247)},
			dcl.PushButton{AssignTo: &connectBtn, Text: "Connect", OnClicked: onConnect, MinSize: dcl.Size{Height: 34}},
			dcl.VSpacer{Size: 8},
			dcl.Label{AssignTo: &statusLabel, Text: "", Font: dcl.Font{Family: "Segoe UI", PointSize: 10, Bold: true}, TextColor: walk.RGB(240, 169, 59)},
			dcl.Label{AssignTo: &detailLabel, Text: "You can close this window at any time to end support.", TextColor: walk.RGB(122, 135, 152)},
		},
	}).Create(); err != nil {
		return
	}
